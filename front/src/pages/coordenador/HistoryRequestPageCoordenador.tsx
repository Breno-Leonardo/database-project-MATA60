...
import { URL_GET_ALL_REQUESTS_ALUNO, URL_GET_ALL_REQUESTS_COORDENADOR} from "../../constants/constants";
import {TeamType} from "../../types/SupervisorType";
...
export function HistoryRequestsPageCoordenador() {
